...
let frontend = fs.readFileSync(path.join(baseDir, "index.html"), "utf8");
  ...
  try {
    ...
    if (typeof pluginModule.default === "function") {
      ...
      if (result) {
        ...
        if (result.frontend) frontend = result.frontend;
      }
    } else {
...
fs.writeFileSync(path.join(__dirname, "index.html"), frontend);
